...
_NB: In the list above and plot below, element names are missing the 'IAP' prefix for brevity._
...
This process resulted in `r with(mm10.IAP.mended, sum(orig.element.ID != element.ID))` elements being combined with other elements, and increased the number of fully-structured IAPs from `r sum(mm10.IAP.reduced.old$fully.structured)` to `r sum(mm10.IAP.reduced$fully.structured)`. An example of the mended vs old (RepeatMasker) annotation is shown below:
